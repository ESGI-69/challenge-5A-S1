 ...
 */
final class Version20240131173753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feedback ADD establishment_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D22944588565851');
        $this->addSql('ALTER TABLE feedback DROP establishment_id');
    }
}
