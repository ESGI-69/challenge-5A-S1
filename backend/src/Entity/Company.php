...
class Company
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['company-read', 'company-create', 'company-update', 'company-getall', 'read-establishment', 'appointment-getall'])]
    private ?int $id = null;
    ...
    #[Groups(['company-create', 'company-getall', 'appointment-getall'])]
