...
class Employee
{
    ...
    #[Groups(['employee-post', 'employee-get', 'employee-patch', 'employee-getall', 'appointment-read','read-company-employees', 'read-establishment-employees', 'appointment-me','read-service', 'company-statistics-getall'])]
