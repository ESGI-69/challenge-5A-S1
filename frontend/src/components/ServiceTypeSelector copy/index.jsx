  ...
  return (
    <div className={styles.ServiceTypeSelector}>
      ...
      <div className={styles.ServiceTypeSelectorActions}>
        <Button onClick={() => onUpdateServiceType({ id, name, description })}>{ t('update', { ns: 'base' }) }</Button>
        <Button variant='danger' onClick={() => onDeleteServiceType({ id })}>{ t('delete', { ns: 'base' }) }</Button>
      </div>
